...
parkinson_model = pickle.load(open('saved models/parkinson_model.sav', 'rb'))

#sidebar for navigate
with st.sidebar:
    selected = option_menu('Multiple Disease Prediction App',
                           ['Diabetes Prediction',
...
if selected == 'Parkinson Prediction':
    ...
    if st.button("Parkinson's Test Result"):
        ...
        if (parkinsons_prediction[0] == 1):
          parkinsons_diagnosis = 'The person does have Parkinson Disease'
        else:
